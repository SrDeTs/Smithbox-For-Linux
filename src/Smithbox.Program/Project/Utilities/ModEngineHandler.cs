...
public static class ModEngineHandler
{
    ...
    private static string NormalizeME3SourcePath(string projectPath)
    {
        ...
        // The Smithbox app is native Linux here, but the ME3 profile is consumed by the
        // game runtime. If that runtime is Wine/Proton, it needs a Windows-visible path.
