...
public enum KeybindID
{
    ...
    ParamEditor_Import_CSV_All_Fields,
...
public static class DefaultKeyBindings
{
    public static void CreateDefaultBindings()
    {
        ...
        InputManager.Bind(KeybindID.ParamEditor_Import_CSV_All_Fields, new() { Key = Key.U, Ctrl = true, Alt = true });
...
public static class KeybindMetadata
{
        ...
        = new()
    {
        ...
        { KeybindID.ParamEditor_Import_CSV_All_Fields, (
            "Import CSV (All Fields)",
            "Import all fields from CSV file"
        ) },
        ...
        = new()
    {
        ...
        { KeybindID.ParamEditor_Import_CSV_All_Fields, InputCategory.ParamEditor },
