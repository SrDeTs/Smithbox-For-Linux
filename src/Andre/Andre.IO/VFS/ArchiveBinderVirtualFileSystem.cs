    ...
    public class ArchiveBinderVirtualFileSystem : VirtualFileSystem
    {
        ...
        public static BhdDictionary GetDictionaryForGame(Game game)
            => game switch
            {
                ...
                Game.DS1 => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","DarkSoulsDictionary.txt")), BHD5.Game.DarkSouls1),
                Game.DS1R => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","DarkSoulsDictionary.txt")), BHD5.Game.DarkSouls1),
                Game.DS2S => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","DarkSouls2Dictionary.txt")), BHD5.Game.DarkSouls2),
                Game.DS3 => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","DarkSouls3Dictionary.txt")), BHD5.Game.DarkSouls3),
                Game.BB => throw new NotImplementedException(),
                Game.SDT => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","SekiroDictionary.txt")), BHD5.Game.DarkSouls3),
                Game.ER => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","EldenRingDictionary.txt")), BHD5.Game.EldenRing),
                Game.NR => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","EldenRingNightreignDictionary.txt")), BHD5.Game.EldenRing),
                Game.AC6 => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","ArmoredCore6Dictionary.txt")), BHD5.Game.EldenRing),
                Game.DS2 => new(File.ReadAllText(Path.Join(AppContext.BaseDirectory, "Assets","UXM Dictionaries","ScholarDictionary.txt")), BHD5.Game.DarkSouls2),
        ...
        public static ArchiveBinderVirtualFileSystem FromGameFolder(string folder, Game game)
        {
            ...
            var binders = BinderArchive.FindBHDs(folder, game)
                ...
                .Where(b => b.BdtStream != null)
                .ToArray();
            AndreLogging.For(typeof(ArchiveBinderVirtualFileSystem)).LogInformation("Loaded {} binder archives from {}", binders.Length, folder);
